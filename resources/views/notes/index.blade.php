    ...
    <div class="row">
        @forelse ($notes as $note)
            <div class="card my-3 mx-3" style="width: 26rem; background-color: #408697;">
                <div class="card-body">
                    <h2 class="font-weight-bold card-title text-white ">{{ $note->title }}</h2>
                    ...
                    <div class="row d-flex justify-content-between">
                        ...
                        <div class="col-auto">
                            <a class="mx-2" href="{{ route('notes.show', $note) }}">
                                <i class="bi bi-eye-fill " style="font-size: 1.1rem; color: rgb(101, 252, 88)"> </i>
                            </a>
                            <a class="mx-2" href="{{ route('notes.edit', $note) }}">
                                <i class="bi bi-pencil-fill" style="font-size: 1.1rem; color: rgb(225, 234, 96)"> </i>
                            </a>
